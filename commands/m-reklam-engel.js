...
module.exports = {
  ...
  run: async(client, interaction) => {
    if(!interaction.member.permissions.has(PermissionsBitField.Flags.ManageRoles)) return interaction.reply({content: ":x: Rolleri Yönet Yetkin Yok!", ephemeral: true})
    const embed = new EmbedBuilder()
    .setDescription(":x: **Sistem Kapatıldı** \n Reklam Yapıldığında Bot Artık Onları Sansürlemicek.")
